# Contributing to Personalization API PHP SDK
Feature requests, bugs, support requests, and milestones are tracked via the [Perz-API-PHP GitHub issue queue](https://github.com/acquia/perz-api-php/issues).
...
* Perz-API-PHP is distributed under the GPLv2 license; all documentation, code, and guidance is provided without warranty.
